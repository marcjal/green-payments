defmodule GreenPaymentsWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GreenPaymentsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GreenPaymentsWeb.Gettext, "errors", msg, opts)
    end
  end
